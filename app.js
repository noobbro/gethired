...
const jobs = [
  { id: 'admin-accounting-executive', title: 'Admin & Accounting Executive', team: 'Administration & Finance', type: 'Full-time · Ajman, UAE · Immediate', summary: 'Join a hands-on team managing day-to-day finance and admin operations.' },
  { id: 'sales-marketing-executive', title: 'Sales & Marketing Executive', team: 'Sales & Marketing', type: 'Full-time · Abu Dhabi, UAE · Immediate', summary: 'Drive new business and client relationships in a fast-moving market.' }
];
...
jobsEl.innerHTML = jobs.map((job, i) => `
  <article class="job-card" style="--delay:${i * 70}ms">
    ...
    <div class="job-meta">
      <p>${job.type}</p>
      <button class="button button-light" type="button" data-job="${job.id}">View role</button>
    </div>
  </article>
`).join('');
